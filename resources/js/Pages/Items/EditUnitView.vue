...
const submitForm = () => {
    form.patch(`/items/${props.item.id}/edit-unit`);
};
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Items</h2>
        </template>
        <div class="py-12">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="submitForm">
                            ...
                            <PrimaryButton type="submit">Edit Items</PrimaryButton>
                        </form>
                    </div>
                </div>
            </div>
